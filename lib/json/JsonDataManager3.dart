      ...
      },
      {
        ...
        "scenarios": [
          ...
          },
          {
            ...
            "correctAnswer": 1,
            "feedback": "Option A shows an understanding of the AI lifecycle—from data collection and model training to deployment—by visually mapping how input (student essays) is processed through an algorithm to provide adaptive feedback.",
            "activity": {
              "type": "Interactive Simulation",
              ...
              "scenes": [
                {
                  ...
                  "options": [
                    "This shows an emphasis on adapting classroom practice through the tool's performance data.",
                    "This shows an emphasis on understanding the tool's underlying design and training process."
                  ]
                },
                {
                  "sceneNumber": 2,
              ...
              "idealPath": "A-B",
              "idealEnding": "By combining classroom adaptation with awareness of how AI is built and trained, teachers B ensure both effective use and responsible application of the tool.",
              "badEnding": "Teacher A is relying only on output data without questioning the tool's design risks overlooking bias and limiting deeper understanding of AI's impact."
            }
          },
          {
            "id": 38,
