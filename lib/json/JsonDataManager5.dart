      ...
      "scenarios": [
        {
          ...
          "options": [
            "Memorize AI definitions and wait for official training",
            "Reflect on how AI might shift teaching roles and identify areas where she can grow professionally",
            "Begin exploring AI tools independently, even if she doesn't fully understand their implications"
          ],
          "correctAnswer": 2,
          "feedback": "Reflecting on how AI is changing her role shows that Ms. Farzana understands the need for continuous learning and professional evolution in the AI era.",
          "activity": {
            ...
            "scenes": [
              {
                "sceneNumber": 1,
                "description": "Profile A: Ms. Aneeza sees AI as a support system that changes how she facilitates learning. She focuses on guiding students in inquiry, reflection, and ethical AI use.",
                "options": [
                  "This reflects appropriate AI-era mindset",
                  "This needs improvement for AI era teaching"
                ]
              ...
              {
                "sceneNumber": 2,
                "description": "Profile B: Mr. Faisal incorporates AI tools like quiz generators and grading assistants, but mostly relies on pre-designed lesson plans. He believes AI helps streamline tasks, but doesn't see much need to change how he engages students in the classroom.",
                "options": [
                  "This reflects appropriate AI-era mindset",
                  "This needs improvement for AI era teaching"
                ]
        ...
        },
        {
          ...
          "options": [
            "Take the most popular AI course without reflection",
            "Stop learning until formal professional development sessions are provided",
            "Use a self-assessment tool to identify specific gaps"
          ],
          "correctAnswer": 3,
          "feedback": "Using a self-assessment tool allows Ms. Rozina to make an informed decision about her professional development journey based on her actual needs.",
          "activity": {
            ...
            "scenes": [
              {
                "sceneNumber": 1,
                "description": "Option A: Mr. Taimoor selects online AI courses based on popularity and struggles to complete them due to a lack of relevance.",
                "options": [
                  "This demonstrates informed learning approach",
                  "This approach lacks direction and planning"
                ]
        ...
        },
        {
          ...
          "question": "Which option best supports this goal?",
          "options": [
            "Use a classroom analysis tool that includes engagement prediction features and visualizes interaction patterns over time",
            "Use a multimedia platform that allows annotation of recorded lessons but offers no learning analytics",
            "Use a note-organizing app to compile student feedback manually after each class"
          ],
          "correctAnswer": 1,
          "feedback": "By selecting an AI tool focused on reflection and classroom analysis, Mr. Karim can gain actionable insights to improve his teaching.",
          "activity": {
