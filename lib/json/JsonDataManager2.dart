    ...
    "levels": [
      {
          ...
          },
        {
            ...
            "activity": {
              "type": "Interactive Simulation",
              "name": "Audit the App",
              "description": "You are Ms. Kulsoom. Your school has adopted an AI language-learning app that only supports dominant languages like English and Spanish. Students who speak indigenous languages like Punjabi and Balochi feel excluded and disengaged.",
              "scenes": [
                {
                  "sceneNumber": 1,
                  ...
                  "options": [
                    "Contact developers to include local languages ",
                    "Give manual worksheets to excluded students"
                  ]
                }
              ],
              "idealPath": "A-B-B-A",
      ...
      },
      {
       ...
       
       {
            ...
            "options": [
              "Let students showcase their projects at a school exhibition.",
              "Pilot the most promising project in class for feedback.",
              "Mentor teams to embed ethical principles and share outcomes with the education council."
            ],
            "correctAnswer": 3,
            "feedback": "While exhibitions and classroom pilots give visibility, mentoring students to apply ethical principles and connect with policymakers ensures innovation is both responsible and impactful.",
            "activity": {
              "type": "Interactive Simulation",
