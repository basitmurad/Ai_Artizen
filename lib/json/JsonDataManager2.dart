...
''';
  ...
  // }
  //
  // static List<dynamic> getLevels() {
  //   final moduleData = getModuleData();
  //   return moduleData['levels'] ?? [];
  // }
  //
  // static List<dynamic> getScenariosByLevel(String levelName) {
  ...
  // static String getModuleTitle() {
  //   final moduleData = getModuleData();
  //   return moduleData['title'] ?? 'Human-Centered Mindset';
  // }
  //
  // static String getModuleName() {
  //   final moduleData = getModuleData();
