...
//           "question": "What should Ms. Zara do to ensure student safety without compromising fairness and cultural inclusion?",
//           "options": [
//             "Recommend continued use of the tool, but propose adding teacher observation as a secondary validation layer.",
//             "Ask the school to wait for updates from the AI vendor before making changes to the system.",
//             "Suggest involving multilingual staff to assess whether flagged behaviors reflect real concerns or linguistic misinterpretation."
//           ],
//           "correctAnswer": 3,
//           "feedback": "Advocating for transparent, unbiased AI helps protect student safety while respecting cultural diversity and fairness.",
//           "activity": {
...
//               {
//                 "sceneNumber": 1,
//                 "description": "You notice Sania, a top student, has been flagged twice this week for using Balochi phrases.",
//                 "options": [
//                   "Talk to the vice principal immediately",
//                   "Collect more evidence from other students"
//                 ]
...
//                 "description": "The ethics committee agrees to review the AI tool.",
//                 "options": [
//                   "Recommend pausing the tool and hiring a cultural linguist to retrain the tool.",
//                   "Recommend using the tools and ignoring the linguistic biases."
//                 ]
//               }
//             ],
//             "idealPath": "B-A-A",
...
//           "id": 2,
//           "title": "Whose Language Counts?",
//           "description": "Ms. Kulsoom's school adopts an AI language-learning app that supports only dominant languages like English and Spanish. However, students from indigenous and marginalized communities feel excluded, as the app does not recognize their native languages.",
//           "question": "How should Ms. Kulsoom respond to ensure all students feel included and valued?",
//           "options": [
//             "Use the app for most students and offer manual support to others",
//             "Reject the app entirely and develop culturally inclusive resources herself",
...
//             "type": "Interactive Simulation",
//             "name": "Audit the App",
//             "description": "You are Ms. Kulsoom. Your school has adopted an AI language-learning app that only supports dominant languages like English and Spanish. Students who speak indigenous languages like Balochi and Punjabi feel excluded and disengaged. You believe all students deserve to feel included.",
//             "scenes": [
//               {
//                 "sceneNumber": 1,
//                 "description": "You notice Karim and Sana quietly skip activities involving the AI app. Their native languages aren't supported.",
...
//             ],
//             "idealPath": "A-B-B-A",
//             "idealEnding": "The developer adds Balochi and Punjabi support in the next update. Students are excited to see their languages respected. Engagement improves schoolwide.",
//             "badEnding": "Without support, the developer drops the idea. Students continue feeling excluded, and the app drives further disengagement."
//           }
//         },
//         {
//           "id": 3,
//           "title": "The Voice That Wasn't Heard",
//           "description": "Mr. Imran introduces an AI-powered reading fluency app in his class. The app tracks and scores students' reading aloud skills using voice recognition. However, students with speech impairments and accents—like Areeba, who stutters, and Karim, who speaks with a regional accent—consistently receive lower scores. They begin to feel embarrassed and excluded during reading sessions.",
//           "question": "What should Mr. Imran do to ensure inclusive and equitable learning for all students?",
//           "options": [
//             "Continue using the app, since it works well for most students",
//             "Allow affected students to skip the app-based activity",
...
//           "id": 5,
//           "title": "Whose Data, Whose Rules?",
//           "description": "Ms. Shazia, a teacher in a private school in Karachi, is asked to implement a new AI-powered student analytics tool. The tool tracks academic performance, emotional responses via webcam, and online behavior patterns. The company claims the system is \\"secure\\" and follows global data protection regulations. However, the software collects biometric and behavioral data without any formal consent from parents or students.",
//           "question": "What should Ms. Shazia do to act ethically and responsibly?",
//           "options": [
//             "Proceed with the tool—it's already used internationally",
//             "Raise the issue with the school administration and request clarity on Pakistan's Personal Data Protection Bill",
...
//                 "options": [
//                   "Organize a student activity to analyze the bias",
//                   "Report directly to the administration without student involvement"
//                 ]
//               }
//             ],
//             "idealPath": "A-A",
//             "idealEnding": "Students participate in identifying bias and learning about algorithmic fairness firsthand. The school uses these findings to improve the tool.",
//             "badEnding": "The administration makes changes without student input, missing a valuable teaching opportunity about AI ethics"
//           }
//         },
//         {
//           "id": 7,
//           "title": "Biometric Data in Islamabad's Smart Classrooms",
//           "description": "A \\"smart school\\" in Islamabad requires fingerprint scans for attendance via an AI system. Parents worry that scans are stored indefinitely and shared with third parties. The admin claims it's \\"secure,\\" but Pakistan lacks robust data laws.",
//           "question": "What should teachers do?",
//           "options": [
//             "Enforce usage; biometrics are \\"modernization.\\"",
//             "Offer manual attendance for students opting out.",
...
//           ],
//           "correctAnswer": 2,
//           "feedback": "Under Pakistan's Personal Data Protection Bill, consent is key to mitigating the risk of forced biometric breaches.",
//           "activity": {
//             "type": "Interactive Simulation",
//             "name": "Privacy Policy Lab",
//             "description": "You're evaluating a new school technology that collects student data.",
...
//                 "description": "You notice the system lacks clear data protection measures.",
//                 "options": [
//                   "Document the privacy gaps and propose solutions to the school administration",
//                   "Assume the vendor has handled security adequately"
//                 ]
//               },
//               {
//                 "sceneNumber": 2,
//                 "description": "The administration asks for specific improvement recommendations.",
//                 "options": [
//                   "Develop a consent process with clear data usage explanations",
//                   "Suggest limiting data collection to only essential information"
//                 ]
...
//             "idealPath": "A-A",
//             "idealEnding": "The school implements transparent data practices.",
//             "badEnding": "Data continues to be collected without proper safeguards."
//           }
//         },
//         {
//           "id": 8,
//           "title": "AI Plagiarism at PU Lahore",
//           "description": "At Punjab University, an AI detector flags a student's Urdu essay as \\"plagiarized\\" due to matching phrases from classical poetry. The student argues that this is common in Urdu literature.",
//           "question": "How should the professor respond?",
//           "options": [
//             "Clarify guidelines for cultural/linguistic nuances.",
//             "Fail the student; AI tools are definitive.",
...
//             "Use it only in urban schools.",
//             "Partner with local NGOs to fund inclusive upgrades.",
//             "Wait for government subsidies in ruler areas."
//           ],
//           "correctAnswer": 2,
//           "feedback": "Pakistan's National Education Policy mandates inclusivity. Offline/low-bandwidth options are critical.",
//           "activity": {
//             "type": "Interactive Simulation",
//             "name": "Inclusive Design Challenge",
//             "description": "You're a teacher using the AI app in a mixed classroom. Some students are thriving, others can't access the tool due to language and connectivity issues.",
//             "scenes": [
//               {
//                 "sceneNumber": 1,
//                 "description": "Half the class is actively engaging. The rest are disconnected—both technically and linguistically.",
//                 "options": [
//                   "Reflect with colleagues on whether continued use of the tool violates ethical values",
//                   "Design parallel paper-based tasks for the excluded group"
//                 ]
//               },
//               {
//                 "sceneNumber": 2,
//                 "description": "Your team recognizes that continued use risks reinforcing systemic inequality.",
//                 "options": [
//                   "Seek local funding to adapt the tool for offline and language inclusion",
//                   "Recommend limiting use of the tool to students who already benefit"
//                 ]
//               }
//             ],
//             "idealPath": "A-A",
//             "idealEnding": "Inclusive Victory!!! Ethical education technology must prioritize non-discrimination, proportionality, and inclusion.",
//             "badEnding": "Equity Failed!! Convenience should never override ethical responsibility. Teachers must lead in ensuring fairness and access for all."
//           }
//         },
//         {
//           "id": 10,
...
//             "Recommend the school continue using the tool, but limit its usage",
//             "Avoid discussing the issue and wait for the district to make a decision.",
//             "Collect data, consult experts, and co-design an energy-efficient alternative with students."
//           ],
//           "correctAnswer": 3,
//           "feedback": "Creating an environmentally conscious AI tool engages students in sustainability and ethical innovation.",
//           "activity": {
...
//             "type": "Interactive Simulation",
//             "name": "Drafting Ethical Impact",
//             "description": "You are Ms. Nilofer. After hosting a multistakeholder simulation on AI ethics in education, your students explored how an AI attendance system could marginalize underrepresented groups. Now, it's time to channel that energy into wider impact.",
//             "scenes": [
//               {
//                 "sceneNumber": 1,
//                 "description": "You realize that most teachers and parents in your school have no idea these biases exist in AI tools.",
//                 "options": [
//                   "Launch a student-led awareness campaign within the school community",
//                   "Archive the debate transcripts for academic use only"
//                 ]
//               },
//               {
//                 "sceneNumber": 2,
//                 "description": "Students design infographics, host Q&A booths during parent-teacher meetings, and publish summaries in the school newsletter to raise awareness.",
//                 "options": [
//                   "Collaborate with the school's digital committee to revise internal tech guidelines",
//                   "Conclude the campaign once awareness is raised"
//                 ]
//               }
//             ],
//             "idealPath": "A-A",
//             "idealEnding": "Ethical advocacy doesn't end in debate—it grows through public awareness and institutional change.",
//             "badEnding": "Missed Potential!! Awareness alone isn't enough—ethical impact requires systems to listen and evolve."
//           }
//         },
//         {
//           "id": 13,
...
//           "question": "What should Ms. Mehreen prioritize?",
//           "options": [
//             "Partner with developers and special educators to co-create an inclusive model.",
//             "Abandon the AI tool for traditional methods.",
//             "Wait for the district to launch a new tool."
//           ],
//           "correctAnswer": 1,
...
//           "id": 14,
//           "title": "Ethics Hackathon",
//           "description": "Mr. Saeed hosts an \\"Ethics in EdTech Hackathon,\\" inviting students to design AI tools that address bullying and low literacy.",
//           "question": "How should Mr. Saeed ensure that the event leads to meaningful outcomes?",
//           "options": [
//             "Let students work freely and enjoy the experience.",
//             "Use the winning project in class regardless of ethical review",
...
//             "Write a blog about the problem.",
//             "Ask students to apply to other platforms",
//             "Work with peers and legal experts to simulate a regulatory framework that ensures fairness."
//           ],
//           "correctAnswer": 3,
//           "feedback": "Simulating regulatory models allows teachers to lead in ethical reforms for AI tools in education.",
//           "activity": {
...
class JsonDataManager2 {
  ...
  "description": "Ms. Zara’s school implements an AI tool to monitor students’ online behavior, aiming to prevent cyberbullying. However, the system frequently flags students like Jameel and Sania, who use minority languages, as “suspicious,” due to translation errors and cultural misunderstandings. What should Ms. Zara do to ensure student safety without compromising fairness and cultural inclusion?",
  "options": [
    "Recommend continued use of the tool, but propose adding teacher observation as a secondary validation layer.",
    "Ask the school to wait for updates from the AI vendor before making changes to the system.",
    "Suggest involving multilingual staff to assess whether flagged behaviors reflect real concerns or linguistic misinterpretation."
  ...
  "activity": {
    ...
    "scenes": [
      ...
      },
      {
        ...
        "options": [
          "Recommend pausing the tool and hiring a cultural linguist to retrain the tool.",
          "Recommend using the tool and ignoring the linguistic biases."
        ]
      }
    ],
    "idealPath": "B-A-A",
...
},
{
  "id": 2,
  "title": "Whose Language Counts?",
  "description": "Ms. Kulsoom’s school adopts an AI language-learning app that supports only dominant languages like English and Spanish. However, students from indigenous and marginalized communities feel excluded, as the app does not recognize their native languages. How should Ms. Kulsoom respond to ensure all students feel included and valued?",
  "options": [
    "Keep using the app but add classroom tasks that value local languages.",
    "Reduce reliance on the app and use diverse language resources.",
    "Use the app while urging developers to include indigenous languages."
  ],
  "correctAnswer": 3,
  "feedback": "Advocating for linguistic inclusion in AI tools ensures every student’s identity is respected and valued in the learning process.",
  "activity": {
    ...
    "scenes": [
      ...
      {
        "sceneNumber": 2,
        "description": "You prepare alternate materials for the marginalized students. But they still feel isolated, and the gap between students widens.",
        "options": [
          "Create your own multilingual resources independently",
          "Email the developers and advocate for the inclusion of local languages"
        ]
      },
      {
        "sceneNumber": 3,
        "description": "The developers respond positively and request examples and local language data to consider integration.",
        "options": [
          "Partner with colleagues and local language teachers to support the initiative",
          "Decline involvement and continue your manual workaround"
        ]
      }
    ],
    "idealPath": "A-B-B-A",
    "idealEnding": "The developer adds Balochi and Punjabi support in the next update. Students are excited to see their languages respected. Engagement improves schoolwide. Lesson Reinforced: Inclusion must be built into AI tools, not added as an afterthought. Advocacy leads to sustainable, equitable change.",
    "badEnding": "Without support, the developer drops the idea. Students continue feeling excluded, and the app drives further disengagement. Lesson Reinforced: Passive fixes can’t address structural exclusion. Inclusion requires proactive, systemic effort."
  }
},
{
  "id": 3,
  "title": "The Voice That Wasn't Heard",
  "description": "Mr. Imran introduces an AI-powered reading fluency app in his class. The app tracks and scores students’ reading aloud skills using voice recognition. However, students with speech impairments and accents—like Areeba, who stutters, and Karim, who speaks with a regional accent—consistently receive lower scores. They begin to feel embarrassed and excluded during reading sessions. What should Mr. Imran do to ensure inclusive and equitable learning for all students?",
  "options": [
    "Continue using the app, since it works well for most students",
    "Allow affected students to skip the app-based activity",
    "Raise concerns with the developers and provide an alternative assessment for excluded students"
  ...
  "activity": {
    "type": "Interactive Simulation",
    "name": "Audit the Algorithm – Reading Fairly",
    "description": "You are Mr. Imran. You use a reading fluency app that rates students’ speech, but those with accents or speech differences get unfairly low scores.",
    "scenes": [
      {
        "sceneNumber": 1,
      ...
      {
        "sceneNumber": 2,
        "description": "Karim and Areeba feel excluded, while other students improve with app feedback.",
        "options": [
          "Create alternative assessments and push the developer to improve speech recognition",
          "Only continue written tasks for affected students privately"
        ]
      }
    ],
    "idealPath": "A-A",
...
},
{
  "id": 4,
  "title": "Not in the Picture",
  "description": "Ms. Hina's school deploys an AI-powered facial recognition system for automating attendance. The system promises efficiency, but within a week, she notices a troubling pattern—students with darker skin tones, those who wear traditional headscarves, and Faizan, a student with facial muscle paralysis due to a disability, are frequently marked absent. Ms. Hina starts logging these errors and finds that these students are being disproportionately affected. When she brings it up informally, a colleague responds, 'It’s a small glitch. It works fine for most students.' What should Ms. Hina do next?",
  "options": [
    "Keep using the system and manually adjust the attendance afterward",
    "Document the bias and formally report it to school leadership or the responsible authority.",
    "Ignore the issue—it’s a technical limitation, not her responsibility"
  ...
  "activity": {
    "type": "Interactive Simulation",
    "name": "Audit the Algorithm – Face the Bias",
    "description": "You are Ms. Hina. A facial recognition tool wrongly marks absent students with dark skin, headscarves, or facial disabilities.",
    "scenes": [
      {
        "sceneNumber": 1,
...
},
{
  "id": 6,
  "title": "Whose Data, Whose Rules?",
  "description": "Ms. Shazia, a teacher in a private school in Karachi, is asked to implement a new AI-powered student analytics tool. The tool tracks academic performance, emotional responses via webcam, and online behavior patterns. The company claims the system is 'secure' and follows global data protection regulations. However, the software collects biometric and behavioral data without any formal consent from parents or students. What should Ms. Shazia do to act ethically and responsibly?",
  "options": [
    "Proceed with the tool—it’s already used internationally",
    "Raise the issue with the school administration and request clarity on Pakistan’s Personal Data Protection Bill",
    "Use the tool but avoid sensitive features like webcam access"
  ...
  "correctAnswer": 2,
  "feedback": "Teachers must uphold ethical standards by ensuring student data is collected lawfully and transparently, respecting privacy and local regulations.",
  "activity": {
    "type": "Interactive Simulation",
    "name": "Audit the Algorithm – Data in the Dark",
    "description": "You are Ms. Shazia. A new AI tool collects students’ biometric and emotional data—but there’s no mention of Pakistan’s privacy laws.",
    "scenes": [
      {
        "sceneNumber": 1,
      ...
      "scenarios": [
  {
    "id": 1,
    "title": "AI Career Bias in a Karachi School",
    "description": "A Lahore-based AI career counselor app recommends engineering/medicine only to male students and teaching/nursing to female students at a Karachi public school. Female students protest, but the principal insists the tool aligns with 'market trends.' How should the teacher address this?",
    "options": [
      "Accept the tool’s recommendations as 'culturally appropriate.'",
      "Manually suggest STEM fields to female students.",
      "Advocate for a bias audit with the Punjab IT Board."
    ...
    "correctAnswer": 3,
    "feedback": "AI tools must avoid reinforcing gender stereotypes. Pakistani schools should align with the Digital Pakistan Vision, which promotes inclusive technology.",
    "activity": {
      "type": "Interactive Simulation",
      "name": "Bias Detection Lab",
      "description": "You are a teacher piloting a new AI career guidance tool. During testing, you notice potential gender bias in the recommendations.",
      "scenes": [
        {
          "sceneNumber": 1,
          "description": "Your test shows the AI recommends different careers based on gender.",
  ...
  },
  {
    "id": 2,
    "title": "Biometric Data in Islamabad’s Smart Classrooms",
    "description": "A 'smart school' in Islamabad requires fingerprint scans for attendance via an AI system. Parents worry that scans are stored indefinitely and shared with third parties. The admin claims it’s 'secure,' but Pakistan lacks robust data laws. What should teachers do?",
    "options": [
      "Enforce usage; biometrics are modernization.",
      "Offer manual attendance for students opting out.",
      "Demand written guarantees from the vendor."
  ...
  },
  {
    "id": 3,
    "title": "AI Plagiarism at PU Lahore",
    "description": "At Punjab University, an AI detector flags a student’s Urdu essay as 'plagiarized' due to matching phrases from classical poetry. The student argues this is common in Urdu literature. How should the professor respond?",
    "options": [
      "Clarify guidelines for cultural/linguistic nuances.",
      "Fail the student; AI tools are definitive.",
      "Ignore the flag; Urdu idioms differ from English."
  ...
  },
  {
    "id": 4,
    "title": "AI Accessibility for Sindh’s Rural Students",
    "description": "An AI tutoring app for Sindh’s schools lacks Urdu/Sindhi support and requires high internet bandwidth. Rural students with disabilities struggle, but the vendor calls updates 'too costly.' What’s the ethical solution?",
    "options": [
      "Use it only in urban schools.",
      "Partner with local NGOs to fund inclusive upgrades.",
      "Wait for government subsidies in rural areas."
    ],
    "correctAnswer": 2,
    "feedback": "Pakistan’s National Education Policy mandates inclusivity. Offline/low-bandwidth options are critical.",
    "activity": {
      ...
      "idealPath": "A-A",
      "idealEnding": "Inclusive victory! Ethical education technology must prioritize non-discrimination, proportionality, and inclusion.",
      "badEnding": "Equity failed! Convenience should never override ethical responsibility."
    }
  },
  {
    "id": 5,
    "title": "AI Surveillance in Peshawar’s Colleges",
    "description": "A Peshawar college uses AI cameras to flag 'suspicious behavior' (e.g., long bathroom breaks). Female students report false flags due to cultural norms like praying during breaks. How should staff address this?",
    "options": [
      "Trust the AI; security outweighs privacy.",
      "Adjust thresholds for gender-specific norms.",
      "Disable surveillance to avoid controversy."
  ...
  },
  {
    ...
    "activity": {
      ...
      "idealPath": "B-A",
      "idealEnding": "The new model becomes a case study for inclusive AI, and students feel proud to have co-created it. Lesson Reinforced: Inclusive AI must be actively designed with the users it seeks to serve—especially marginalized groups.",
      "badEnding": "Students feel their input is ignored. The excitement fades, and the accessibility issue persists. Lesson Reinforced: Delaying inclusive action leads to disengagement and sustained inequity."
    }
  },
  {
    "id": 4,
    ...
    "activity": {
      ...
      "idealPath": "B-A",
      "idealEnding": "Students learn how ethics strengthen innovation. They feel proud of making socially valuable tools. Lesson Reinforced: Creativity must be guided by ethical thinking to produce meaningful and inclusive AI solutions.",
      "badEnding": "Projects work technically but ignore ethical risks. A bullying-report app raises privacy concerns and gets rejected by the school."
    }
  },
  {
    ...
    "activity": {
      ...
      "idealPath": "B-A",
      "idealEnding": "Your efforts influence policy talks, and other schools start replicating your model. Lesson Reinforced: Teachers can lead regulatory innovation to ensure AI respects diversity and fairness.",
      "badEnding": "The platform is abandoned, but no alternatives exist. Marginalized students remain excluded from scholarship visibility."
    }
  }
]
