...
//   }
//
//   void _handleNextAction(Scenario scenario, int index) {
...
//
//   void _completeLevel() {
//     // Calculate score and navigate back
...
class _LevelScenariosScreenState extends State<LevelScenariosScreen>
  ...
  Future<void> _updateUserProgress(bool isCorrect, int scenarioId) async {
    try {
      User? user = _auth.currentUser;
      if (user == null) return;
  ...
  void _handleNextAction(Scenario scenario, int index) async {
    ...
    await _updateUserProgress(isCorrect, scenario.id);
