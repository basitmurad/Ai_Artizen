...
// //   Map<int, int> userAnswers = {}; // scenario_id -> selected_option
// //
// //   // New: Store reasoning for each scenario
// //   Map<int, List<int>> userReasonings = {}; // scenario_id -> list of selected reasoning indices
// //
// //   bool isLoading = true;
// //
// //   // Firebase instances
...
// //           SizedBox(height: 20),
// //
// //           // Reasoning Section - Only show if an answer is selected
// //           if (userAnswers.containsKey(scenario.id))
// //             _buildReasoningSection(scenario),
// //
// //           SizedBox(height: 20),
// //
// //           // Navigation buttons
...
// //   }
// //
// //   Widget _buildReasoningSection(Scenario scenario) {
// //     return Container(
// //       padding: EdgeInsets.all(16),
// //       decoration: BoxDecoration(
...
// //           ...reasoningOptions.asMap().entries.map((entry) {
// //             int reasoningIndex = entry.key;
// //             String reasoningText = entry.value;
// //             bool isSelected = userReasonings[scenario.id]?.contains(reasoningIndex) ?? false;
// //
// //             return Container(
// //               margin: EdgeInsets.only(bottom: 8),
// //               child: InkWell(
// //                 onTap: () => _toggleReasoning(scenario, reasoningIndex),
...
// //     setState(() {
// //       userAnswers[scenario.id] = optionIndex;
// //       // Initialize reasoning list for this scenario if not exists
// //       if (!userReasonings.containsKey(scenario.id)) {
// //         userReasonings[scenario.id] = [];
// //       }
// //     });
// //
// //     print('✅ Selected option $optionIndex for scenario ${scenario.id}');
// //   }
// //
// //   void _toggleReasoning(Scenario scenario, int reasoningIndex) {
// //     setState(() {
// //       if (!userReasonings.containsKey(scenario.id)) {
// //         userReasonings[scenario.id] = [];
// //       }
// //
// //       List<int> currentReasonings = userReasonings[scenario.id]!;
// //       if (currentReasonings.contains(reasoningIndex)) {
// //         currentReasonings.remove(reasoningIndex);
// //       } else {
// //         currentReasonings.add(reasoningIndex);
// //       }
// //     });
// //
// //     print('🧠 Updated reasoning for scenario ${scenario.id}: ${userReasonings[scenario.id]}');
// //   }
// //
// //   void _goToPreviousScenario() {
// //     if (currentScenarioIndex > 0) {
...
// //     int userAnswer = userAnswers[scenario.id] ?? 0;
// //     bool isCorrect = userAnswer == scenario.correctAnswer;
// //     List<int> selectedReasonings = userReasonings[scenario.id] ?? [];
// //
// //     print('\n🎯 === ANSWER CHECK ===');
// //     print('Module: ${widget.moduleID}');
// //     print('Scenario: ${scenario.title}');
...
// //     print('Correct Answer: ${scenario.correctAnswer}');
// //     print('Is Correct: $isCorrect');
// //     print('Selected Reasonings: $selectedReasonings');
// //     print('========================\n');
// //
// //     // Save reasoning data to Firebase
// //     await _saveReasoningData(scenario, selectedReasonings);
// //
// //     // Update progress using ProgressManager
// //     int newCoinCount = await _progressManager.updateScenarioProgress(
// //       scenario: scenario,
...
// //   }
// //
// //   Future<void> _saveReasoningData(Scenario scenario, List<int> selectedReasonings) async {
// //     try {
// //       // Use ProgressManager to save reasoning data
// //       await _progressManager.saveScenarioReasoning(
// //         scenario: scenario,
// //         selectedReasoningIndices: selectedReasonings,
// //         reasoningOptions: reasoningOptions,
// //         userAnswer: userAnswers[scenario.id] ?? 0,
// //       );
// //     } catch (e) {
// //       print('❌ Error saving reasoning data: $e');
// //     }
// //   }
// //
// //   void _showAnswerFeedback(bool isCorrect, String message) {
...
//     print('========================\n');
//
//     // Update progress with reasoning in SINGLE call
//     int newCoinCount = await _progressManager.updateScenarioProgress(
//       scenario: scenario,
//       isCorrect: isCorrect,
//       currentUserData: userData,
//       selectedReasoningIndices: selectedReasonings.isNotEmpty ? selectedReasonings : null,
//       reasoningOptions: selectedReasonings.isNotEmpty ? reasoningOptions : null,
...
//   }
//
//   // Remove this method since reasoning is now handled in updateScenarioProgress
//   /*
//   Future<void> _saveReasoningData(Scenario scenario, List<int> selectedReasonings) async {
...
//   //   print('========================\n');
//   //
//   //   // Save reasoning data to Firebase FIRST (before other operations)
//   //   if (selectedReasonings.isNotEmpty) {
//   //     print('💾 Saving reasoning data for scenario ${scenario.id}...');
//   //     await _saveReasoningData(scenario, selectedReasonings);
//   //   } else {
//   //     print('⚠️ No reasoning selected for scenario ${scenario.id}');
//   //   }
//   //
//   //   // Update progress using ProgressManager
//   //   int newCoinCount = await _progressManager.updateScenarioProgress(
...
//   Future<void> _saveReasoningData(Scenario scenario, List<int> selectedReasonings) async {
//     try {
//       // Use ProgressManager to save reasoning data - this matches the scenario progress structure
//       await _progressManager.saveScenarioReasoning(
//         scenario: scenario,
//         selectedReasoningIndices: selectedReasonings,
//         reasoningOptions: reasoningOptions,
...
//       );
//     } catch (e, stackTrace) {
//       print('❌ Error in _saveReasoningData: $e');
