  ...
  String _getModuleName() {
    switch (widget.moduleID) {
      ...
      case 'ai_professional_development':
        return 'Ai Professional Development';
      default:
    ...
    try {
      ...
      switch (widget.moduleID) {
        ...
        case 'ai_pedagogy':
          ...
          break;
          case 'ai_professional_development':
          print('📂 Loading JsonDataManager6 for ai_professional_development');
          educationModule = JsonDataManager4.getModule();
          _printCompleteModuleData(educationModule, 'JsonDataManager6');
          break;
